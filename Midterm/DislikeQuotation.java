...
/**
 * Servlet implementation class DislikeQuotation
 */
@WebServlet("/Midterm/DislikeQuotation")
public class DislikeQuotation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DislikeQuotation() {
        super();
